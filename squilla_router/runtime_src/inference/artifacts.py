...
class V3FeatureRuntime:
    ...
    def extract_handcrafted(self, text: str) -> np.ndarray:
        from squilla_router.runtime_src.features import extract_handcrafted
    ...
    def extract_context(self, metadata: dict) -> np.ndarray:
        from squilla_router.runtime_src.features import ContextMetadata, extract_context_features
    ...
    def extract_hist(self, prev_route_decisions: list) -> np.ndarray:
        from squilla_router.runtime_src.features import extract_hist_features
...
class InferenceArtifacts:
    ...
    def load_runtime_objects(self, config: dict, *, use_aux_head: bool) -> dict[str, object]:
        ...
        from squilla_router.runtime_src.v4_features import BGEChannelExtractor
