...
from squilla_router.runtime_src.features import ContextMetadata
from squilla_router.runtime_src.flags import RoutingFlags, compute_flags
...
class SquillaRouter:
    ...
    def __new__(cls, model_dir: str = "models/", *args, **kwargs):
        ...
        if version_path.exists():
            try:
                ...
                ver = None
            if ver == "v4":
                from squilla_router.runtime_src.v4_predictor import V4Router
    ...
    def __init__(self, model_dir: str = "models/",
        ...
        from squilla_router.runtime_src.features import FeatureExtractor
    ...
    def predict(self, text: str, context: ContextMetadata | None = None, *,
        ...
        from squilla_router.runtime_src.trajectory import classify as classify_trajectory
