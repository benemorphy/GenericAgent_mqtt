...
_P1_HINT_EN = "Normal balanced reasoning. Provide complete answers with moderate detail."
_P1_HINT_ZH = "标准平衡推理。提供完整答案，适当展开细节。"
_P2_HINT_EN = "Thorough analysis. Use deep reasoning, explore edge cases, consider alternatives, provide comprehensive coverage."
_P2_HINT_ZH = "深度分析。使用深度推理，探索边界情况，考虑替代方案，提供全面覆盖。"

# 本体实体类型到压缩级别的映射
_ONTOLOGY_COMPRESS_MAP = {
...
# 本体深度阻断阈值（调用链深度 > 此值时不压缩）
_COMPRESS_BLOCK_ONT_DEPTH = 2
