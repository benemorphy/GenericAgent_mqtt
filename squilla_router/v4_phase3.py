...
from squilla_router.router_tiers import (
    DEFAULT_TEXT_TIER,
    ROUTE_CLASS_TO_TIER,
)
from squilla_router.controller import TIER_ORDER, select_localized_prompt_hint
...
def default_bundle_dir() -> Path:
    ...
    return Path(__file__).resolve().parent / "models" / "v4_bundle"
...
# 别名: 与 cascade_router 兼容
V4Phase3Predictor = V4Phase3Strategy
