...
from .bbs import TaskMessage, TaskOutput, TaskStatus
...
class AgentBoardWithPersistence:
    ...
    def post_task(self, task_type: str, task_input: dict,
        ...
        from .bbs import TaskMessage, TaskStatus
        if task_id is None:
...
class WorkerAgentWithPersistence:
    ...
    def complete(self, task_id: str, status: str = "completed",
        ...
        from .bbs import TaskOutput, TaskStatus
        output = TaskOutput(
            task_id=task_id,
