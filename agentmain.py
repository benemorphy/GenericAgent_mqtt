...
if __name__ == '__main__':
    ...
    parser.add_argument('--task', metavar='IODIR', help='文件IO模式 (默认: MQTT)')
    parser.add_argument('--repl', action='store_true', help='交互式REPL模式')
    ...
    if args.task:
        ...
        if sys.stdin.isatty():
            while True:
                ...
                except KeyboardInterrupt: agent.abort(); print()
    else:
